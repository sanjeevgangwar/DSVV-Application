...
class WorkshopWebinarPage extends StatefulWidget {
  final imgPath, headerColor, cardName;

  const WorkshopWebinarPage(
      {Key? key,
  ...
  @override
  State<WorkshopWebinarPage> createState() => WorkshopWebinarPageState();
}

class WorkshopWebinarPageState extends State<WorkshopWebinarPage> {
  List<String> workshopWebinarImagesFirstPart = [
  ...
  List<String> workshopWebinarImagesSecondPart = [
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                ...
                                physics: const BouncingScrollPhysics(),
                                itemCount: workshopWebinarImagesFirstPart.length,
                                itemBuilder: ((context, index) {
                                  return Container(
                                    margin: const EdgeInsets.only(right: 10),
                                    child: buildOneItem(
                                        workshopWebinarImagesFirstPart[index]),
                                  );
                                }),
                              ),
                            ),
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                scrollDirection: Axis.horizontal,
                                physics: const BouncingScrollPhysics(),
                                itemCount: workshopWebinarImagesSecondPart.length,
                                itemBuilder: ((context, index) {
                                  return Container(
                                    margin: const EdgeInsets.only(right: 10),
                                    child: buildOneItem(
                                        workshopWebinarImagesSecondPart[index]),
                                  );
                                }),
                              ),
                            ),
